...
ALLOW_INSECURE_HTTP = config("ALLOW_INSECURE_HTTP", default=False, cast=bool)
...
XRAY_GENERATED_CONFIG_PATH = config("XRAY_GENERATED_CONFIG_PATH", default="/var/lib/marzban/generated_config.json")
